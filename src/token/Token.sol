...
contract MyToken is ERC20, ERC20Burnable, AccessControl, ERC20Permit {
    ...
    address public constant DEVELOPMENT_FUND_ADDRESS = address(0);
    address public constant TEAM_RESERVE_ADDRESS = address(0);
    address public constant PARTNERS_ADVISORS_ADDRESS = address(0);
    address public constant MARKETING_ADDRESS = address(0);
